...
//
// Same math as q4_matvec_residual_add, but with 8 rows per threadgroup
// (256 threads = 8 SIMD groups) to amortize the shared-x load over more rows.
[[kernel]]
void q4_matvec_residual_add_8row(
